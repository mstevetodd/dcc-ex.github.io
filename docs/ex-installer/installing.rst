...
* **Access Point mode** |BR| You can configure for EX-CommandStation to have its own, completely isolated, WiFi Network. This is referred to as *Access Point Mode*. (Most useful if your layout is away from the house, you transport your layout frequently, or do not want to give guests access to your home layout.) |BR| To enable, select ``Use my EX-CommandStation as an Access Point`` 
